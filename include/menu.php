...
?>
    ...
    <nav class="blue-grey darken-1">
        <div class="nav-wrapper">
            <a href="./" class="brand-logo center hide-on-large-only"><i class="material-icons md-36">school</i>UNMA</a>
                ...
                <li class="no-padding">
                    <div class="logo-side center blue-grey darken-3">
                        ...
                        while ($data = mysqli_fetch_array($query)) {
                            if (!empty($data['logo'])) {
                                echo '<img class="logo-ump" src="./upload/' . $data['logo'] . '"/>';
                            } else {
                            ...
                            if (!empty($data['nama'])) {
                                ...
                                echo '<h5 class="smk-side">Universitas Muhammadiyah Purwokerto</h5>';
                            }
            ...
            <ul class="center hide-on-med-and-down" id="nv">
                <li><a href="./" class="ams hide-on-med-and-down"><i class="material-icons md-36">school</i>UNMA</a></li>
                <li>
                    <div class="grs">
                        </>
                </li>
