    ...
    if ($_SESSION['admin'] != 1 and $_SESSION['admin'] != 2) {
        ...
        if (isset($_REQUEST['sub'])) {
            ...
            if (isset($_REQUEST['submit'])) {
                ...
                if (
                    $_REQUEST['institusi'] == "" || $_REQUEST['nama'] == "" || $_REQUEST['status'] == "" || $_REQUEST['alamat'] == "" || $_REQUEST['kepsek'] == "" || $_REQUEST['nidn'] == ""
                    ...
                    if (!preg_match("/^[a-zA-Z0-9. -]*$/", $nama)) {
                        ...
                        if (!preg_match("/^[a-zA-Z0-9. -]*$/", $institusi)) {
                            ...
                            if (!preg_match("/^[A-Za-z0-9 .,;:()\"\/@-]*$/", $_POST['status'])) {
                                ...
                                if (!preg_match("/^[A-Za-z0-9 .,;:()\"\/@-]*$/", $_POST['alamat'])) {
                                    ...
                                    if (!preg_match("/^[a-zA-Z., ]*$/", $kepsek)) {
                                        ...
                                        if (!preg_match("/^[0-9 -]*$/", $nidn)) {
                                            $_SESSION['nidnkepsek'] = 'Form NIDN Kepala Sekolah hanya boleh mengandung karakter angka, spasi, dan minus(-)<br/><br/>';
                                            echo '<script language="javascript">window.history.back();</script>';
                                        } else {
                                            ...
                                            if (!filter_var($website, FILTER_VALIDATE_URL)) {
                                                ...
                                                if (!filter_var($email, FILTER_VALIDATE_EMAIL)) {
                                                    ...
                                                    if (!empty($logo)) {
                                                        ...
                                                        $query = mysqli_query($config, "UPDATE tbl_instansi SET institusi='$institusi',nama='$nama',status='$status',alamat='$alamat',kepsek='$kepsek',nidn='$nidn',website='$website',email='$email',id_user='$id_user' WHERE id_instansi='$id_instansi'");
                            ...
                            <form class="col s12" method="post" action="?page=sett" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="input-field col s6">
                                        ...
                                        <!-- Menghilangkan validasi dan escape karakter, sehingga input dapat menerima simbol dan karakter apapun -->
                                        <input id="status" type="text" class="validate" name="status" maxlength="1000" value='<?php echo $row['status']; ?>' required>
                                        <?php
                                    ...
                                    <div class="input-field col s6">
                                        ...
                                        ?>
                                        <label for="kepsek">Nama Rektor</label>
                                    </div>
                                    <div class="input-field col s6">
                                    ...
                                    <div class="input-field col s6">
                                        ...
                                        <input id="nidn" type="text" class="validate" name="nidn" value="<?php echo $row['nidn']; ?>" required>
                                        <?php
                                        if (isset($_SESSION['nipkepsek'])) {
                                            $nidnkepsek = $_SESSION['nidnkepsek'];
                                            echo '<div id="alert-message" class="callout bottom z-depth-1 red lighten-4 red-text">' . $nidnkepsek . '</div>';
                                            unset($_SESSION['nidnkepsek']);
                                        }
                                        ?>
                                        <label for="nip">NIDN Rektor</label>
                                    </div>
                                    <div class="input-field col s6">
                                    ...
                                    <div class="input-field col s6 tooltipped" data-position="top" data-tooltip="Jika tidak ada logo, biarkan kosong">
                                        <div class="file-field input-field">
                                            ...
                                            ?>
                                            <small class="red-text">*Format file yang diperbolehkan hanya *.JPG, *.PNG dan ukuran maksimal file 10 MB. Disarankan gambar berbentuk kotak atau lingkaran!</small>
                                        </div>
                                    </div>
                                    <div class="input-field col s6">
