    ...
    if (isset($_REQUEST['submit'])) {
            ...
            if (!preg_match("/^[0-9]*$/", $no_agenda)) {
                ...
                if (!preg_match("/^[a-zA-Z0-9.\/ -]*$/", $no_surat)) {
                    ...
                    if (!preg_match("/^[a-zA-Z0-9.,() \/ -]*$/", $asal_surat)) {
                        ...
                        if (!preg_match("/^[A-Za-z0-9 .,;:()\"\/@[\]&-]*$/", $_POST['isi'])) {
                            ...
                            if (!preg_match("/^[0-9.-]*$/", $tgl_surat)) {
                                ...
                                if (!preg_match("/^[A-Za-z0-9 .,;:()\"\/@[\]&-]*$/", $_POST['keterangan'])) {
        ...
        <div class="row jarak-form">
            ...
            <form class="col s12" method="POST" action="?page=tsm&act=add" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col s6">
                        <button class="btn cyan waves-effect waves-light right" type="submit" name="submit">Simpan Data</button>
                    </div>
                </div>
            </form>
            <!-- Form END -->
